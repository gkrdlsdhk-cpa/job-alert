...
1~2분 후 Gmail `[세금 뉴스]` 메일 (TaxWatch + 이택스뉴스) + 텔레그램 「브리핑 메일 보기」 알림.
...
[TaxWatch 최신뉴스](https://www.taxwatch.co.kr/search)와 [이택스뉴스](https://www.etaxnews.com/) **세정(내국세·지방세)·유권해석**에서 **오늘(KST) 올라온 기사**를 Gmail HTML로 보내고, **텔레그램**으로 「브리핑 메일 보기」 알림을 보냅니다.
